                        ...
                        <div class="col-md-12 rtcl-login-form-wrap">
                            ...
                            <form id="rtcl-signup-form" class="form-horizontal" method="post" novalidate="novalidate" onSubmit={signUpHandle}>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <div class="form-check form-check-inline"><input type="radio" name="gender" value={details.gender}
                                     onChange={(e) => {
                                         setDetails((prev) => {
                                             return { ...prev, gender:"Female" };
                                         });
                                     }}/> Female</div>
                                    <div class="form-check form-check-inline"><input type="radio" name="gender"
                                    value={details.gender}
                                     onChange={(e) => {
                                         setDetails((prev) => {
